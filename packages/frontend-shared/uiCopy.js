    ...
    en: {
        ...
        dashboard: {
            homePhase2: {
                ...
                heroSubtitle: "Stop babysitting AI coding work. AI coding does not lack models. It lacks a command tower. OpenVibeCoding gives teams one governed operator path to plan, delegate, track, resume, and prove long-running engineering work across Codex and Claude Code.",
                ...
                productSpineDescription: "Start from the live command deck, not the adoption catalog. The loop stays simple: plan, delegate, track, resume, and prove through Command Tower, Workflow Cases, and Proof & Replay.",
                productSpineCards: [
                    {
                        href: "/command-tower",
                        title: "Command Tower",
                ...
                publicTemplatesDescription: "Start with `news_digest` first. It is the official public baseline. `topic_brief` is still a showcase path until it earns its own healthy proof bundle. `page_brief` now has a tracked browser-backed proof bundle, but it is still not the official first public baseline.",
                ...
                publicAdvantagesDescription: "OpenVibeCoding is not just one more prompt wrapper. It turns prompt, context, and harness decisions into explicit product surfaces so long-running work keeps moving when humans step away.",
                ...
                ecosystemDescription: "Keep the front door anchored on Codex, Claude Code, and read-only MCP. Mention OpenHands and comparison-only tools in the ecosystem layer, not in the hero.",
                ...
                integrationDescription: "Once the command deck is clear, use the router to choose the right proof-first, protocol, playbook, package, or ecosystem lane without turning the homepage into a docs catalog.",
                ...
                aiSurfacesDescription: "AI in OpenVibeCoding is not a floating chat box. It already shows up as a pre-run advisor, a workflow-level explainer, and a run/compare operator brief.",
                ...
                builderDescription: "This is not a full SDK platform, but the builder entrypoints now include the read-only MCP quickstart, the API and contract quickstart, and the package-level client/shared surfaces.",
                ...
                liveCaseGalleryDescription: "Use real Workflow Cases as proof-ready reference cases. This baseline links to live case detail and a share-ready recap instead of inventing demo-only gallery data.",
                ...
                firstTaskGuideDescription: "Start with the request, watch Command Tower, confirm the Workflow Case, then inspect Proof & Replay. It stays collapsed by default to keep the first screen quiet.",
            ...
            commandTowerPage: {
                ...
                unavailableNextAction: "Reload first. If live data is still missing, inspect runs for the latest verified state or start from PM to rebuild the active path.",
                unavailableBadge: "Live data missing",
                partialTitle: "Command Tower is running with partial truth",
                partialNextAction: "Use the visible overview as a partial snapshot only. Confirm runs or Workflow Cases directly before taking approval, rollback, or release decisions.",
                ...
                liveHome: {
                    ...
                    refreshHealth: {
                        ...
                        partialDegradation: (okCount) => `Partial degradation (${okCount}/3)`,
                    },
                    snapshot: {
                    ...
                    freshness: {
                        ...
                        sourceFallback: (source) => `Last refresh source: ${source}`,
                        lastSuccessfulSeconds: (seconds) => `Last successful refresh ${seconds}s ago`,
                        lastSuccessfulMinutes: (minutes) => `Last successful refresh ${minutes}m ago`,
                        lastSuccessfulHours: (hours) => `Last successful refresh ${hours}h ago`,
                    },
                    actionFeedback: {
                        ...
                        focusSwitchSuccess: (modeLabel) => `Switched focus view to ${modeLabel}`,
                        ...
                        appliedDraftFilters: (count) => `Applied draft filters (${count} items)`,
                    ...
                    layout: {
                        ...
                        snapshotTimestampOnly: (label) => `${label}. Timestamps only show when the snapshot was generated, not the live state.`,
                        degradedActionsAriaLabel: "Degraded-state actions",
                        reviewFailureEvents: "Review failure events",
                        reviewRuns: "Review runs",
                        reload: "Reload",
                        riskSampleSummary: (total, failed, blocked, running) => `Risk sample: ${total} sessions (high risk ${failed}, blocked ${blocked}, running ${running}).`,
                        ...
                        sessionBoardMeta: (visible, total) => `This list stays in sync with the quick actions above and currently shows ${visible} / ${total} sessions with risk-first ordering.`,
                        cachedSnapshotBadge: "Cached snapshot",
                        sessionBoardListAriaLabel: "Session board list",
                        laneQuickActionsAriaLabel: (laneTitle) => `${laneTitle} quick actions`,
                    ...
                    viewModel: {
                        ...
                        contextHealth: {
                            ...
                            runningValue: (intervalMs) => `Running (${intervalMs}ms)`,
                            pausedValue: "Paused",
                        ...
                        drawerPrompts: {
                            criticalAlerts: (count) => `Detected ${count} critical alerts. Triage them first and verify the suggested actions.`,
                            currentIssue: (label) => `Current issue: ${label}. Run Refresh now first to confirm whether it persists.`,
                            unappliedDraftFilters: (count) => `Detected ${count} unapplied draft filters. Apply them before judging the risk trend.`,
                            riskCounts: (failed, blocked) => `High-risk sessions ${failed}, blocked sessions ${blocked}. Use the focus switcher to narrow quickly.`,
                        ...
                        priorityLanes: {
                            liveTitle: "Live Lane",
                            liveSummary: (status, intervalMs) => `${status} · interval ${intervalMs}ms`,
                            riskTitle: "Risk Lane",
                            riskSummary: (failed, blocked, critical) => `Failed ${failed} · Blocked ${blocked} · critical ${critical}`,
                            actionsTitle: "Action Lane",
                            draftFiltersWaiting: (count) => `${count} draft filters waiting`,
            ...
            runDetailPage: {
                ...
                degradedNextAction: "Retry this page first. If the same source is still unavailable, inspect the surviving Run Detail tabs and then return to the run list.",
                ...
                compareNextStepNeedsReview: "Next step: Open compare and decide whether to replay, investigate, or keep the run blocked.",
            ...
            workflowDetailPage: {
                ...
                subtitle: "Classify risk first, then confirm the case summary, run mapping, queue posture, and event timeline before taking governance action.",
                ...
                degradedNextAction: "Use the visible case identity, event timeline, and run mapping for diagnosis only. Wait for the data path to recover before taking approval, rollback, replay, or queue actions.",
                ...
                degradedRunMappingReadonlyNote: "Read-only note: use the run chain for assessment only, not for direct governance actions.",
                degradedEventTimelineTitle: "Event timeline sample (degraded)",
                degradedEventTimelineReadonlyNote: "Events remain visible, but governance actions should wait until the data path is restored.",
            ...
            workflowListPage: {
                title: "Workflow Cases",
                subtitle: "Workflow Cases keep queue posture, linked runs, verdict, and later Proof & Replay decisions attached to the same operating record.",
            ...
            runsPage: {
                ...
                failureHeadline: (failed) => `Failed ${failed}`,
                successHeadline: (success) => `Succeeded ${success}`,
                failureSubline: (success, running) => `Failure-first · Succeeded ${success} · Running ${running}`,
                successSubline: (running, failed) => `Success-first · Running ${running} · Failed ${failed}`,
                operatorPriorityHeadline: (failed) => `Review failed runs first: ${failed}`,
                ...
                firstScreenLimit: (visibleCount) => `The first screen is capped at the latest ${visibleCount} runs so proof review stays readable.`,
            },
            contractsPage: {
                title: "Contract desk",
                subtitle: "Use the contract desk to inspect execution authority, bundle posture, runtime binding, and the next contract blocker before trusting a task to continue.",
                countsBadge: (contractCount) => `${contractCount} contracts`,
                searchLabel: "Search",
                searchPlaceholder: "Filter by task_id / run_id / path",
                applyFilter: "Apply filter",
                filterSummary: (visible, total, defaultLimit) => `Showing ${visible} / ${total} contracts. Default first-screen limit: ${defaultLimit}.`,
                ...
                moreHidden: (count) => `${count} more contracts are hidden.`,
                showAll: "Show all",
            },
            agentsPage: {
                title: "Role desk",
                subtitle: "Open the role desk to confirm execution seats, runtime bindings, and scheduler posture. Treat capacity numbers as supporting evidence, not the product story.",
                ...
                metricSublines: {
                    risk: (statuses, healthy) => `State machine ${statuses} / Non-failed ${healthy}`,
                    riskHint: "This card tracks runtime state only. Use it to decide which lane needs evidence review first.",
                    execution: (activeAgents, capacityRatio) => `Bound agents ${activeAgents} (attach rate ${capacityRatio}%)`,
                    executionHint: "This card confirms registered seats and bindings. It does not describe pending scheduler backlog.",
                    scheduler: (unassignedStatuses, unassignedFailedStatuses) => `Unassigned tasks ${unassignedStatuses} / Unassigned failures ${unassignedFailedStatuses}`,
                    schedulerHint: (lockedAgentCount) => `Agents holding locks ${lockedAgentCount}; this measures queue posture, not agent health.`,
                },
                actions: {
                ...
                roleCatalog: {
                    ...
                    subtitle: "This registry-backed view shows role purpose, bundle posture, runtime binding, and execution authority without promoting the catalog into the authority source.",
                    fullList: "Full list",
                ...
                filters: {
                    ...
                    subtitle: "Use role and keyword filters to separate registered execution seats from scheduler backlog and failure records.",
                ...
                stateMachine: {
                    ...
                    subtitle: 'Use this table to inspect lanes run by run. "Pending scheduling" means scheduler backlog, not an automatic agent fault.',
                    summaryBadge: (statuses, sample) => `State machine ${statuses} (first-screen sample ${sample})`,
                    failedBadge: (failed, currentPageFailed) => `Failed lanes ${failed} (current page ${currentPageFailed})`,
                    unassignedFailuresBadge: (count) => `Unassigned failures ${count}`,
                    viewFailedRuns: "View failed runs in bulk",
                    emptyTitle: "No active runs",
                    sampleHint: (visible) => `The first screen shows the ${visible} samples that need the most triage. Continue paging for the rest.`,
                    headers: {
                        runId: "Run ID",
                        taskId: "Task ID",
                        role: "Role",
                ...
                registeredInventory: {
                    title: (count) => `Registered execution seats (expandable, ${count} items)`,
                ...
                locks: {
                    title: (total, pageCount) => `Lock posture (${total} total, ${pageCount} on this page)`,
                ...
                pagination: {
                    status: (page, totalPages, pageSize) => `Page ${page} / ${totalPages} (${pageSize} rows per page)`,
                    previous: "Previous",
                    next: "Next",
                },
            },
        ...
        desktop: {
            ...
            runDetail: {
                ...
                pendingApprovalWithCount: (count) => `This run is waiting for human approval (${count} item(s)). Next step: complete the approval before continuing.`,
                pendingApprovalWithoutCount: "This run is marked as awaiting human approval. Next step: complete the approval before continuing.",
                operatorCopilotTitle: "AI operator copilot",
                operatorCopilotIntro: "Generate one bounded operator brief grounded in current run, compare, proof, incident, workflow, queue, and approval truth.",
                ...
                bindingReadModel: {
                    ...
                    runtimeCapability: "Runtime capability",
                    toolExecution: "Tool execution",
                    readOnlyNote: "Read-only note: this mirrors the persisted binding summary. task_contract still owns execution authority.",
                },
                completionGovernance: {
                    ...
                    runtimeNote: "Runtime-evaluated read-back: this report reflects the live completion evaluator. task_contract still owns execution authority; this report does not replace the contract.",
                    ...
                    advisoryNote: "Derived from persisted worker prompt contracts and unblock tasks. These summaries stay advisory; task_contract still owns execution authority.",
                },
                fieldLabels: {
                    runId: "Run ID",
                    taskId: "Task ID",
            ...
            workflowDetail: {
                ...
                operatorRoleLabel: "Operator role",
                roleGateReason: "This environment has not published an operator role yet, so queue actions remain read-only until the command tower can prove who is allowed to dispatch work.",
                queueSummary: (queueCount, eligibleCount) => `Queued items visible: ${queueCount}. Ready now: ${eligibleCount}.`,
                ...
                queuedNotice: (taskId) => `Queued ${taskId}. Refreshing the workflow view...`,
                startedNotice: (runId) => `Started queued work as run ${runId}. Refreshing the workflow view...`,
                ...
                workflowCopilotIntro: "Generate one bounded workflow brief grounded in workflow status, queue posture, the latest linked run, proof, compare, incident, and approval truth.",
                ...
                recommendedActionQueued: "Queued work already exists. The next high-value action is to run the next queued task and watch the case move.",
                recommendedActionNoQueue: "No queued work exists yet. Queue the latest run contract to move this Workflow Case into SLA tracking.",
                recommendedActionNoRun: "No run is available yet. Start or resume a run before you queue this Workflow Case.",
                summaryTitle: "Workflow Case Summary",
                readModelTitle: "Workflow read model",
                noReadModel: "No workflow read model is attached yet.",
                relatedRunsTitle: (count) => `Related Runs (${count})`,
                noRelatedRuns: "No related runs",
                eventsTitle: (count) => `Events (${count})`,
                noEvents: "No events",
                queueSlaTitle: (count) => `Queue / SLA (${count})`,
                noQueuedWork: "No queued work for this workflow case.",
                queueMeta: (priority, sla) => `priority ${priority} / sla ${sla}`,
                summaryLabels: {
                    status: "status",
                    objective: "objective",
                    owner: "owner",
                ...
                readModelLabels: {
                    ...
                    readOnlyNote: "Read-only note: this workflow summary mirrors the latest linked run binding summary. The task contract still owns execution authority.",
                },
            },
            overview: {
                title: "Command deck overview",
                subtitle: "OpenVibeCoding starts with one loop: start the task, watch Command Tower, confirm the Workflow Case, then verify Proof & Replay. Only open approvals when the flow asks for one.",
                refreshData: "Refresh data",
                ...
                approvalCheckpointDesc: "Use the approval workspace only when the flow pauses for human confirmation.",
                ...
                progressCards: {
                    ...
                    needsAttentionHint: "Prioritize the affected Run detail and decide whether to rollback, reject, or replay.",
                ...
                noExceptionsYet: "No exception signals yet. Failed runs and risk events will appear here after tasks start running.",
                ...
                quickActions: {
                    ...
                    step1Desc: "Start at the PM entrypoint, state the goal and acceptance criteria, and let the system open the session.",
                    ...
                    step3Desc: "Open Workflow Cases to confirm queue posture, operating verdict, and the current case record.",
    ...
    "zh-CN": {
        ...
        dashboard: {
            homePhase2: {
                ...
                publicTemplatesDescription: "先从 `news_digest` 开始。它是官方公开基线。`topic_brief` 仍是展示路径，直到它拿到自己的健康证明包。`page_brief` 现在已经有已追踪的浏览器证明包，但它仍不是官方第一公开基线。",
                ...
                publicAdvantagesDescription: "OpenVibeCoding 不是再包一层花哨 prompt，而是把 prompt、context 和 harness 这三类最容易失控的东西，都拉进显式、可检查、可演进的系统里。",
                publicAdvantageCards: [
                    {
                        href: "/pm",
                        title: "提示词工程",
                ...
                ecosystemDescription: "前门继续以 Codex、Claude Code 和只读 MCP 为主轴。OpenHands 和 comparison-only 工具只放在生态层，不放进 hero。",
                ...
                integrationDescription: "先把 command deck 认清，再把 compatibility matrix 当成主路由，把 proof-first 指南当成最快建立信任的入口，最后再进入协议、playbook、package 或 AI 页面。",
                ...
                builderDescription: "这还不是完整 SDK 平台，但 builder 入口现在已经同时覆盖 read-only MCP quickstart、API and contract quickstart，以及 package 级 client/shared surface。",
                ...
                liveCaseGalleryDescription: "把真实工作流案例当作可验的参考案例来使用。这里会直接链接可实时查看的案例详情和可分享 recap，而不是伪造演示专用的画廊数据。",
            ...
            approval: {
                ...
                panelTitle: "审批工作台",
                panelIntro: "这里先给你看待拍板事项，再把权限缺口和读取失败单独提示。队列安静，不代表全局以后都不再需要人工确认。",
                ...
                manualHint: "如果某个 run 已经卡在人工确认，但没有出现在待处理卡片里，可以手动粘贴运行 ID 从这里继续处理。",
                runIdLabel: "运行 ID",
                ...
                statusFailed: (message) => `审批失败：${message}`,
            },
            commandTowerPage: {
                unavailableTitle: "指挥塔实时总览暂不可用",
                unavailableNextAction: "先重试。如果实时数据仍然缺失，就打开运行记录确认最后一个已验证状态，或从 PM 入口重新建立主路径。",
                unavailableBadge: "实时数据缺失",
                partialTitle: "指挥塔当前只提供部分真相",
                partialNextAction: "当前可见总览只能算部分快照。做审批、回滚或发布判断前，先直接核对 Runs 或 Workflow Cases。",
                partialBadge: "上下文不完整",
                actions: {
                    reload: "重载指挥塔",
                    viewRuns: "查看运行记录",
                ...
                liveHome: {
                    ...
                    refreshHealth: {
                        fullHealthy: "完整刷新健康",
                        refreshFailed: "刷新失败",
                        partialDegradation: (okCount) => `部分降级（${okCount}/3）`,
                    },
                    snapshot: {
                    ...
                    freshness: {
                        ...
                        sourceFallback: (source) => `最近刷新来源：${source}`,
                        lastSuccessfulSeconds: (seconds) => `上次成功刷新距今 ${seconds} 秒`,
                        lastSuccessfulMinutes: (minutes) => `上次成功刷新距今 ${minutes} 分钟`,
                        lastSuccessfulHours: (hours) => `上次成功刷新距今 ${hours} 小时`,
                    },
                    actionFeedback: {
                        ...
                        focusSwitchSuccess: (modeLabel) => `已切换到 ${modeLabel}`,
                        ...
                        appliedDraftFilters: (count) => `已应用草稿筛选（${count} 项）`,
                    ...
                    layout: {
                        ...
                        snapshotTimestampOnly: (label) => `${label}。时间戳只表示快照生成时间，不代表实时状态。`,
                        degradedActionsAriaLabel: "降级状态动作",
                        reviewFailureEvents: "查看失败事件",
                        reviewRuns: "查看运行记录",
                        reload: "重新加载",
                        riskSampleSummary: (total, failed, blocked, running) => `风险样本：共 ${total} 个会话（高风险 ${failed}、阻塞 ${blocked}、运行中 ${running}）。`,
                        ...
                        sessionBoardMeta: (visible, total) => `这个列表会和上方快捷动作保持同步，当前按风险优先顺序显示 ${visible} / ${total} 个会话。`,
                        cachedSnapshotBadge: "缓存快照",
                        sessionBoardListAriaLabel: "会话面板列表",
                        laneQuickActionsAriaLabel: (laneTitle) => `${laneTitle} 快捷动作`,
                    ...
                    viewModel: {
                        ...
                        contextHealth: {
                            liveEngine: "实时引擎",
                            runningValue: (intervalMs) => `运行中（${intervalMs}ms）`,
                            pausedValue: "已暂停",
                            sloHealth: "SLO 健康度",
                            focusHit: "焦点命中",
                            filterState: "筛选状态",
                            filtersApplied: (count) => `已应用 ${count} 个筛选`,
                            filtersOff: "筛选关闭",
                        },
                        drawerPrompts: {
                            criticalAlerts: (count) => `检测到 ${count} 个严重告警。先处理它们，再核对建议动作是否成立。`,
                            currentIssue: (label) => `当前问题：${label}。先执行一次“立即刷新”，确认它是否仍然存在。`,
                            unappliedDraftFilters: (count) => `检测到 ${count} 个未应用的草稿筛选。先应用，再判断风险趋势。`,
                            riskCounts: (failed, blocked) => `高风险会话 ${failed} 个，阻塞会话 ${blocked} 个。用焦点切换器先收窄范围。`,
            ...
            runDetailPage: {
                ...
                degradedNextAction: "先重试当前页面。如果同一数据源仍不可用，就先查看还能显示的 Run Detail 标签页，再回到运行列表。",
                degradedBadge: "部分数据",
            ...
            workflowDetailPage: {
                ...
                degradedNextAction: "现在只能用可见的案例身份、事件时间线和 Run 映射来做诊断。在数据链路恢复前，不要执行审批、回滚、重放或队列动作。",
                degradedBadge: "只读",
            ...
            runsPage: {
                ...
                successSubline: (running, failed) => `先看成功面 · 运行中 ${running} · 失败 ${failed}`,
                operatorPriorityHeadline: (failed) => `先复核失败运行：${failed}`,
                ...
                firstScreenLimit: (visibleCount) => `首屏只显示最新 ${visibleCount} 条运行，避免证明复核面一上来就过载。`,
            },
            contractsPage: {
                title: "合约桌",
                subtitle: "把这里当成合约分诊台：先确认执行权、技能/MCP 配置、运行时绑定和护栏，再决定这条任务应不应该继续往前跑。",
                countsBadge: (contractCount) => `${contractCount} 份合约`,
                searchLabel: "搜索",
                searchPlaceholder: "按 task_id / run_id / path 过滤",
                applyFilter: "应用筛选",
                filterSummary: (visible, total, defaultLimit) => `当前显示 ${visible} / ${total} 份合约。默认首屏上限：${defaultLimit}。`,
                ...
                moreHidden: (count) => `还有 ${count} 份合约未在首屏展开。`,
                showAll: "显示全部",
            },
            agentsPage: {
                title: "角色桌",
                subtitle: "把这里当成角色治理台：先确认哪条执行线失稳、哪些执行席位真实在线、调度队列卡在哪，再决定回到哪条 run 或 workflow 继续处理。",
                ...
                metricSublines: {
                    risk: (statuses, healthy) => `状态机总数 ${statuses} / 非失败 ${healthy}`,
                    riskHint: "这张卡只看运行状态，用来决定先去哪条线做证据复核。",
                    execution: (activeAgents, capacityRatio) => `已绑定代理 ${activeAgents}（绑定率 ${capacityRatio}%）`,
                    executionHint: "这张卡只回答“谁真的在线、谁真的绑上了”；它不负责描述等待调度的队列积压。",
                    scheduler: (unassignedStatuses, unassignedFailedStatuses) => `未分配任务 ${unassignedStatuses} / 未分配失败 ${unassignedFailedStatuses}`,
                    schedulerHint: (lockedAgentCount) => `当前有 ${lockedAgentCount} 个持锁代理；它反映的是队列姿态，不是代理健康度。`,
                },
                actions: {
                ...
                roleCatalog: {
                    title: "角色目录（只读镜像）",
                    subtitle: "这里展示角色目的、技能包、MCP 工具包、运行时绑定和执行权摘要，但目录本身不是执行权来源。",
                    fullList: "完整列表",
                ...
                stateMachine: {
                    ...
                    summaryBadge: (statuses, sample) => `状态机 ${statuses} 条（首屏样本 ${sample} 条）`,
                    failedBadge: (failed, currentPageFailed) => `失败执行线 ${failed} 条（当前页 ${currentPageFailed} 条）`,
                    unassignedFailuresBadge: (count) => `未分配失败 ${count} 条`,
                    viewFailedRuns: "批量查看失败运行",
                    emptyTitle: "当前没有活动运行",
                    sampleHint: (visible) => `首屏优先展示最需要分诊的 ${visible} 条样本；其余内容继续翻页查看。`,
                    headers: {
                        runId: "运行 ID",
                        taskId: "任务 ID",
                        role: "角色",
                ...
                registeredInventory: {
                    title: (count) => `已注册执行 seats（可展开，${count} 项）`,
                ...
                locks: {
                    title: (total, pageCount) => `锁姿态（共 ${total} 条，本页 ${pageCount} 条）`,
                    emptyTitle: "当前没有锁记录",
                    tableAriaLabel: "锁姿态表",
                    headers: {
                        lockId: "锁 ID",
                ...
                pagination: {
                    status: (page, totalPages, pageSize) => `第 ${page} / ${totalPages} 页（每页 ${pageSize} 条）`,
                    previous: "上一页",
                    next: "下一页",
                },
            },
        ...
        desktop: {
            ...
            runDetail: {
                ...
                pendingApprovalWithCount: (count) => `这个 Run 正在等待人工审批（${count} 项）。下一步：先完成审批再继续。`,
                pendingApprovalWithoutCount: "这个 Run 被标记为等待人工审批。下一步：先完成审批再继续。",
                operatorCopilotTitle: "AI 操作员副驾驶",
                operatorCopilotIntro: "生成一份有边界的操作员摘要，基于当前 run、compare、proof、incident、workflow、queue 和 approval 真相。",
                ...
                bindingReadModel: {
                    ...
                    runtimeCapability: "运行时能力",
                    toolExecution: "工具执行",
                    readOnlyNote: "只读说明：这里展示的是持久化的角色绑定摘要镜像；`task_contract` 仍然掌握执行权威。",
                },
                completionGovernance: {
                    title: "完成治理摘要",
                    ...
                    runtimeNote: "运行时只读回读：这份报告反映的是 live completion evaluator 的结论；`task_contract` 仍然掌握执行权威，这份报告不是第二份执行合同。",
                    ...
                    advisoryNote: "这些摘要来自持久化的工作者提示合约和解阻塞任务；它们只提供参考，`task_contract` 仍然掌握执行权威。",
                },
                fieldLabels: {
                    runId: "Run ID",
                    taskId: "任务 ID",
            ...
            workflowDetail: {
                ...
                operatorRoleLabel: "操作角色",
                roleGateReason: "当前环境还没有发布可执行的操作角色，所以队列动作保持只读；先确认这条 command tower 由谁负责，再回来推进队列。",
                queueSummary: (queueCount, eligibleCount) => `当前可见队列项：${queueCount}。现在可执行：${eligibleCount}。`,
                queueLatestRun: "排入最新 Run 合约",
                runNextQueuedTask: "运行下一条排队任务",
                queueingTask: "加入队列中...",
                runningTask: "运行中...",
                noRunAvailable: "当前没有可加入队列的 Run。",
                queuedNotice: (taskId) => `已将 ${taskId} 加入队列，正在刷新工作流视图...`,
                startedNotice: (runId) => `已启动排队工作，Run 为 ${runId}。正在刷新工作流视图...`,
                ...
                workflowCopilotIntro: "生成一份有边界的工作流摘要，基于 workflow 状态、队列姿态、最新 linked run、proof、compare、incident 与 approval 真相。",
                ...
                relatedRunsTitle: (count) => `相关 Run（${count}）`,
                noRelatedRuns: "当前没有相关 Run",
                eventsTitle: (count) => `事件（${count}）`,
                noEvents: "当前没有事件",
                queueSlaTitle: (count) => `队列 / SLA（${count}）`,
                noQueuedWork: "这个工作流案例当前没有排队工作。",
                queueMeta: (priority, sla) => `优先级 ${priority} / SLA ${sla}`,
                summaryLabels: {
                    status: "状态",
                    objective: "目标",
                    owner: "负责人",
                ...
                readModelLabels: {
                    ...
                    mcpBundle: "MCP 包",
                    runtimeBinding: "运行时绑定",
                    readOnlyNote: "只读说明：这里展示的是最新 linked run 的绑定摘要镜像；`task_contract` 仍然掌握执行权威。",
                },
            },
            overview: {
                title: "指挥面总览",
