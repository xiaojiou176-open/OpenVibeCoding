    ...
    en: {
        ...
        dashboard: {
            homePhase2: {
                ...
                publicTemplatesDescription: "Start with `news_digest` first. It is the official public baseline. `topic_brief` and `page_brief` stay useful, but they are still showcase paths until they earn their own healthy proof bundles.",
    ...
    "zh-CN": {
        ...
        dashboard: {
            homePhase2: {
                ...
                publicTemplatesDescription: "先从 `news_digest` 开始。它是官方公开基线。`topic_brief` 和 `page_brief` 仍然有用，但在拿到各自健康证明包之前，它们仍属于展示路径。",
