    ...
    en: {
        ...
        dashboard: {
            homePhase2: {
                ...
                liveCaseGalleryDescription: "Use real Workflow Cases as lightweight showcase assets. This baseline links to live case detail and share-ready recap instead of inventing demo-only gallery data.",
    ...
    "zh-CN": {
        ...
        dashboard: {
            homePhase2: {
                ...
                liveCaseGalleryDescription: "把真实 Workflow Cases 作为轻量 showcase asset 来使用。这里会直接链接 live case detail 和可分享 recap，而不是伪造 demo-only 画廊数据。",
