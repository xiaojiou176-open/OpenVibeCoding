...
today is still repo-local consumption, clone-and-reuse, or vendored workspace
reuse until the first package release is published.

Start with the fuller package guide here:
