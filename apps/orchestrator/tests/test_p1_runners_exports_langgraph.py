...
import cortexpilot_orch.runners as runners
...
def test_runners_lazy_export_resolves_flow_modules() -> None:
    ...
    assert contract_flow.__name__ == "cortexpilot_orch.runners.agents_contract_flow"
    assert stream_flow.__name__ == "cortexpilot_orch.runners.agents_stream_flow"
