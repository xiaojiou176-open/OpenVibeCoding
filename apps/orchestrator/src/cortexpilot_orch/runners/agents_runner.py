...
from cortexpilot_orch.runners.agents_runner_execution_helpers import execute_agents_contract
from cortexpilot_orch.runners import common as runner_common
from cortexpilot_orch.runners import (
    agents_binding,
    agents_events,
    agents_handoff,
...
def _resolve_codex_base_url() -> str:
    explicit = os.getenv("CORTEXPILOT_CODEX_BASE_URL", "").strip()
    if explicit:
        return explicit
