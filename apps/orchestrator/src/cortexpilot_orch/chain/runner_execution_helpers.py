...
from cortexpilot_orch.chain.helpers import _normalize_depends, _step_task_id
from cortexpilot_orch.chain.parsers import _extract_contracts, _extract_handoff_payload
...
def execute_task_subprocess(
    *,
    ...
    cmd = [sys.executable, "-m", "cortexpilot_orch.cli", "run", str(contract_ref)]
    if mock_mode:
        cmd.append("--mock")
    env = os.environ.copy()
