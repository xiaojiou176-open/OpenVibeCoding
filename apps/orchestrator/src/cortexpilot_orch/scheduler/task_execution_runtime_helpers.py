...
from cortexpilot_orch.scheduler import task_execution_review_helpers
    ...
    *,
    ...
    while True:
        ...
        if (
            ...
            and os.getenv("CORTEXPILOT_DIFF_GATE_SCOPED_REVERT", "").strip().lower()
            in {"1", "true", "yes"}
        ):
        ...
        evals_enabled = os.getenv("CORTEXPILOT_EVALS_ENABLED", "").strip().lower() in {"1", "true", "yes"}
