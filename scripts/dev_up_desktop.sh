...
- OPENVIBECODING_DESKTOP_PORT (default: 18173)
...
DESKTOP_PORT="${OPENVIBECODING_DESKTOP_PORT:-18173}"
...
DESKTOP_PORT="$(resolve_port "$DESKTOP_PORT" "Desktop" "OPENVIBECODING_DESKTOP_PORT" "$API_PORT")"
